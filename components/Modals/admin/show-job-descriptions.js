...
function ShowJobDescriptionsModal({ handleShowJobDescriptionsModal, modalOpen }) {
  ...
  return (
    <Modal
      toggle={handleShowJobDescriptionsModal}
      isOpen={modalOpen}
      size="md"
    //fullscreen
    >
                ...
                <Col className="mb-3" md="12">
                  <div>
                    <span className="name mb-0 text-sm">
                      Cargo Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa sint deleniti voluptatem necessitatibus. Deleniti dolorem, delectus sed quidem quas modi dicta esse sit inventore assumenda voluptas cumque odit nulla dignissimos?
                    </span>
                  </div>
                </Col>
              </div>
...
ShowJobDescriptionsModal.defaultProps = {
  handleShowJobDescriptionsModal: () => { },
  modalOpen: false,
};

ShowJobDescriptionsModal.propTypes = {
  handleShowJobDescriptionsModal: PropTypes.func,
  modalOpen: PropTypes.bool,
};

export default ShowJobDescriptionsModal;