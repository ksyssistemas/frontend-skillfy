        ...
        <footer className="footer pt-0 py-4" style={{ backgroundColor: "#FFEEE5" }}>
                ...
                <Nav className="nav-footer justify-content-center justify-content-lg-end">
                  <NavItem>
                    <NavLink
                      ...
                      target="#"
                    >
                      <span className="nav-link-inner--text text-orange">Planos</span>
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink
            ...
            <Row className="align-items-center justify-content-lg-between mb-2 ml-1">
              <Nav className="nav-footer justify-content-center justify-content-lg-start">
                <NavItem>
                  <span className="description text-orange text-sm">(47) 3222-4555 - (47) 98765-4321</span>
                </NavItem>
              </Nav>
            </Row>
            <Row className="align-items-center justify-content-lg-between ml-1">
              <Nav className="nav-footer justify-content-center justify-content-lg-start">
                <NavItem>
                  <span className="text-orange">Rua João da Silva, Nº 2, Sala 206, Centro, Blumenau/SC</span>
                </NavItem>
              </Nav>
              <Col lg="6">
                <Nav className="nav-footer justify-content-center justify-content-lg-end">
