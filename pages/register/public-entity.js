...
function PublicEntityRegister() {
  ...
  return (
    <Form>
      <AdminHeader name="Entidade Pública" parentName="Cadastros" />
      <Container className="mt--6" fluid>
        <Card className="mb-4">
          <CardHeader>
            <h3 className="mb-0">Cadastrar Entidade</h3>
          </CardHeader>
          <CardBody>
            <Form>
              ...
              <Row>
                ...
                >
                  ...
                  >
                    <span className="btn-inner--text">Adicionar Entidade</span>
                  </Button>
                </Col>
              </Row>
            </Form>
...
PublicEntityRegister.layout = Admin;

export default PublicEntityRegister;
